...
<script>
	...
	$.post("includes/handlers/checkSent.php", {userLoggedIn:userLoggedIn, userTo:userTo}, function(data){
...
setInterval(checkSent, 1500);
	...
	$(function(){
		...
		$(document).keypress(function(e){
			...
			$.post("includes/handlers/message_sent.php", {userLoggedIn:userLoggedIn, userTo:userTo});
