...
<div class="main_column column">
    ...
    Cloing your account will hide your profile and all your activity from other users.<br><br>
    ...
    <form action="close_account.php" method="POST">
        ...
        <input type="submit" name="cancel"id="udpade_details" value="No Way! (Mh Gnoito!)" class="success settings_submit">
    </form>
