    ...
    if(md5($old_password) == $db_password) {
        ...
        if($new_password_1 == $new_password_2) {
            ...
            if(strlen($new_password_1) <= 4) {
                $password_message = "Sorry, your password must ber greater than 4 characters<br><br>";
            }
        else {
            ...
            $password_message = "Your Password Does not match!<br><br>";
        }
        
    }
         else {
            $password_message = "The old pasword is incorrect!<br><br>";
        }
}
